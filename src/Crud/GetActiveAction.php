...
final class GetActiveAction implements GetActionInterface
{
    ...
    {
        $entity = $this->repository->getActiveEntity($dto->getId());
        ...
        if (!$this->isDisableEvent) {
            $this->eventDispatcher->dispatch(new GetEvent($entity), 'crud.getactive.after');
        }
